...
Scenario Outline: Verify CP 403 Outage page
	...
	And verify text '<text4>' on page

	Examples:
	| Heading1                                           | Heading2                             | OutageLink                   | text1                                              | text2                                                | text3                                      | text4                                                               |
	| You cannot access this page or perform this action | Check a pet travelling from GB to NI | go back to the previous page | If you typed the web address, check it is correct. | If you tried to save some information in the service | Contact your team leader with any queries. | If you pasted the web address, check you copied the entire address. |
...
Scenario Outline: Verify CP 404 Outage page
	...
	And I force to load the 404 error page
	Then verify heading '<Heading1>' on page
	And verify heading '<Heading2>' on page
	And verify text '<text1>' on page
	And verify text '<text2>' on page

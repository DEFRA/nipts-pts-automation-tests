...
Scenario: View Pet travel documents in WELSH
	...
	Examples: 
	| logininfo | nextPage                      | nextPage1              | Pet | MicrochipNumber | PetBreed | MicrochipOption | nextPage2 | PetName | nextPage3       | PetSex | nextPage4    | nextPage5					    | nextPage6			       | color | nextPage7                     | featureOption | nextPage8              | nextPage10                    | FooterLang1 | FooterLang2 | nextPage9	 |
	| test2     | Lifelong pet travel documents | What breed is your dog | Dog | 676789876543321 | Pug      | Yes             | name      | toto    | sex is your pet | Male   | Beth yw rhyw | dyddiad geni eich anifail anwes | Beth yw prif liw eich ci | Black    | unrhyw nodweddion arwyddocaol | No      | Gwiriwch eich atebion  | Lifelong pet travel documents | English     | Cymraeg     | manylion chi |

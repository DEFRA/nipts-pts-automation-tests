...
Scenario Outline: Verify View Invalid link and invalid documents page in WELSH 
...
Scenario Outline: Verify canceled status on Invalid documents page in WELSH
	Given that I navigate to the Pets application portal
	When  sign in with valid credentials with logininfo '<logininfo>'
...
Scenario Outline: Verify unsuccessful status on Invalid documents page in WELSH
	Given that I navigate to the Pets application portal
	When  sign in with valid credentials with logininfo '<logininfo>'
	Then  I should redirected to Apply for a pet travel document page
	When  I click Create a new pet travel document button
...
Scenario Outline: Verify back link on invalid documents page in WELSH 
	Given that I navigate to the Pets application portal
	When  sign in with valid credentials with logininfo '<logininfo>'
	Then  click on Welsh language
	When  click View Invalid documents link in WELSH
...
Examples:
	...
	| logininfo | FullName     | Are your details correct | PostCode | PhoneNumber | MicrochipOption | MicrochipNumber | Pet   | PetName | Gender | Color | IsSignificantFeatures | nextpage                             | nextpage1             | nextpage2  | nextpage3   | nextpage4               | nextpage5                       | nextpage6        | nextpage7                     | nextpage8             | PetBreed | nextpage9 | nextpage10              |
	| test5     | Updated Name | Ydyn                     | CV1 4PY  | 02012345678 | Oes             | 123456789123456 | Cath  | Cat     | Gwryw  | Du    | Nac oes               | anifail anwes gael microsglodyn wedi | rhain yw eich anifail | Pa frid yw | Beth yw enw | rhyw eich anifail anwes | dyddiad geni eich anifail anwes | yw prif liw eich | unrhyw nodweddion arwyddocaol | Gwiriwch eich atebion | Basenji  | Cais wedi | Dogfennau teithio gydol |



Scenario Outline: Verify canceled status PTD on Invalid documents page in WELSH
	Given that I navigate to the Pets application portal
	When  sign in with valid credentials with logininfo '<logininfo>'
	Then  I should redirected to Apply for a pet travel document page
	When  I click Create a new pet travel document button
...
Examples:
	...
	| logininfo | FullName     | Are your details correct | PostCode | PhoneNumber | MicrochipOption | MicrochipNumber | Pet | PetName | Gender | Color | IsSignificantFeatures | nextpage                             | nextpage1             | nextpage2  | nextpage3   | nextpage4               | nextpage5                       | nextpage6        | nextpage7                     | nextpage8             | PetBreed | nextpage9 | nextpage10              |
	| test5     | Updated Name | Ydyn                     | CV1 4PY  | 02012345678 | Oes             | 123456789123456 | Ci  | Dog     | Gwryw  | Du    | Nac oes               | anifail anwes gael microsglodyn wedi | rhain yw eich anifail | Pa frid yw | Beth yw enw | rhyw eich anifail anwes | dyddiad geni eich anifail anwes | yw prif liw eich | unrhyw nodweddion arwyddocaol | Gwiriwch eich atebion | Basenji  | Cais wedi | Dogfennau teithio gydol |


Scenario Outline: Verify unsuccessful status PTD on Invalid documents page in WELSH
	Given that I navigate to the Pets application portal
	When  sign in with valid credentials with logininfo '<logininfo>'
	Then  I should redirected to Apply for a pet travel document page
	When  I click Create a new pet travel document button
	...
	When  click View Invalid documents link in WELSH
	Then  verify next page 'Dogfennau annilys' is loaded
	Then  I should see the application in 'Yn aflwyddiannus' status 
	When  I have clicked the View hyperlink from invalid documents page
	Then  verify next page 'Crynodeb o' is loaded
...
Scenario Outline: Verify latest application is displayed at the top on Invalid documents page in WELSH
	Given that I navigate to the Pets application portal
	When  sign in with valid credentials with logininfo '<logininfo>'
	Then  I should redirected to Apply for a pet travel document page
	When  I click Create a new pet travel document button

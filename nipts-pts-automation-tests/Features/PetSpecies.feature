...
Scenario: Select species on Pets Application Portal Page in the WELSH language
	...
	| Sign in using Government Gateway | test      | Dogfennau teithio gydol oes i anifeiliaid anwes | Oes microsglodyn | Oes             | 767876543212332 | anifail anwes gael microsglodyn | yw eich anifail anwes chi | Dwedwch a ydych chi | English        | Ci    | ci chi     |
	| Sign in using Government Gateway | test      | Dogfennau teithio gydol oes i anifeiliaid anwes | Oes microsglodyn | Oes             | 767876543212332 | anifail anwes gael microsglodyn | yw eich anifail anwes chi | Dwedwch a ydych chi | English        | Cath  | cath chi   |
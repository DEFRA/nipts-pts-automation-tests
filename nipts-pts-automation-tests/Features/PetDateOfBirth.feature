...
Scenario: Enter valid pet date of birth and validate next page in the application in WELSH
	...
	| test      | Dogfennau teithio gydol oes i anifeiliaid anwes | Beth yw enw | Ci  | 676789876543321 | Ci Affgan | Yes             | rhyw eich anifail anwes | toto    | Gwryw  | dyddiad geni eich anifail anwes |     02    |  03         |   2099     | 01           | 03             | 2024          | Rhowch ddyddiad sydd yn y gorffennol  |

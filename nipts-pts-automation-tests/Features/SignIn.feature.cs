...
#line hidden
        ...
        public void VerifySignOutIsDisplayedInWELSHLanguage(string nextPage, string logininfo, string signOutLinkText, string displayedLang, string signOutLinkText2, string displayedLang2, string nextPage1, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("nextPage", nextPage);

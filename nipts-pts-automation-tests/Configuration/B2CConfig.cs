namespace nipts_pts_automation_tests.Configuration
{
    public class B2CConfig
    {
        ...
        /// </summary>
        public string BackendTotpSecret { get; set; }
    }
}
